                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div className="min-w-0 flex-1">
                                    <div className="flex flex-col gap-0.5 md:flex-row md:items-start md:justify-between md:gap-2">
                                        <p className="flex min-w-0 items-center gap-1 font-bold leading-tight text-neutral-900">
                                            {meta.name}
                                            <HelpTip label={meta.name} text={meta.help} />
                                        </p>
                                        <p className="whitespace-nowrap text-lg font-black tabular-nums text-neutral-900 md:shrink-0 md:text-base">
